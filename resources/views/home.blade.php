...
<!--
    ...
    <p>＜更新履歴＞</P>
    <p>2023/11/1 ページネーション追加、ログイン画面左上表示修正。</p>
    <p>2023/11/2 itemsテーブル、ItemSeeder作成。</p>
    <p>2023/11/4 itemseeder修正。画面全体表示機能追加。</p>
    <p>2023//11//8 Itemsテーブルに製品コード、在庫数追加。製品登録画面、
        seeder修正。登録項目の削除機能作成、編集画面、編集機能作成、フラッシュメッセージ追加。</p>
    ...
    <p>2023/11/15 一覧表示、登録画面、編集画面調整。</p>
    <p>2023/11/18 資料作成</p>
-->
@stop
